...
if ( ! defined( 'MTPHR_POST_DUPLICATOR_DIR' ) ) {
	define( 'MTPHR_POST_DUPLICATOR_DIR', get_template_directory().'/assets/plugins/post-duplicator/' );
}

// Plugin Folder URL.
if ( ! defined( 'MTPHR_POST_DUPLICATOR_URL' ) ) {
	define( 'MTPHR_POST_DUPLICATOR_URL', get_template_directory_uri().'/assets/plugins/post-duplicator/' );
}
